...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-medium-purple sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
            ...
            <div class="sidebar-brand-text mx-3">NetItWorks</div>
        </a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseGroupManagement" class="collapse" aria-labelledby="collapseGroupManagement" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="group_create.php">Create Group</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseRadiusManagement" class="collapse" aria-labelledby="collapseRadiusManagement" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="radius_session_log.php">Active Session Log</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseGuestManagement" class="collapse" aria-labelledby="collapseGuestManagement" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="users_pending.php">Pending Approval</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseDatabaseManagement" class="collapse" aria-labelledby="collapseDatabaseManagementLabel" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="controller_configure.php">Configure Controller</a>
                    <a class="collapse-item" href="radius_configure.php">Configure Radius</a>
                </div>
            </div>
        </li>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo ($_SESSION['admin_id']); ?></span>
